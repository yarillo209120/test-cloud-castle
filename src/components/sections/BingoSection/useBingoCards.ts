...
const initialCards: BingoCard[] = [
  {
    ...
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-1.png`
  },
  {
    id: 2,
    title: 'Литература',
    ...
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-2.png`
  },
  {
    id: 3,
    title: 'Искусство',
    backContent: 'Иску́сство — одна из наиболее общих категорий эстетики, искусствознания и художественной практики.',
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-3.png`
  },
  {
    id: 4,
    title: 'Математика',
    ...
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-4.png`
  },
  {
    id: 5,
    title: 'Химия',
    ...
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-5.png`
  },
  {
    id: 6,
    title: 'История',
    ...
    bgImage: `${process.env.NODE_ENV === 'production' ? '/test-cloud-castle' : ''}/images/bingo-back-bg-6.png`
  }
];
