...
- При наведении на карточку бинго - карточка переворачивается. Что бы зафиксировать заднее положение карточки с информацией - достаточно кликнуть на карточку. Следующий клик перевернет карточку обратно :)
- В мобильной версии навигация по разделу "маршрут" улучшена специальным скроллом для удобства пользователя. Кликните, например, на "Факультативы" с вашего телефона и вы сразу попадаете на информационный блок :)
- Кому интересно досмотреть проект до конца - можете обратить внимание что в футере не просто надпись! :)



## 📱 Тесты

1. Тест адаптивности: http://iloveadaptive.com/ru/url/https%3A%2F%2Fyarillo209120.github.io%2Ftest-cloud-castle%2F
2. Тест на валидность: https://validator.w3.org/nu/?doc=https%3A%2F%2Fyarillo209120.github.io%2Ftest-cloud-castle%2F
3. Тест на скорость загрузки: https://pr-cy.ru/speed_test/?device=desktop&url=https%3A%2F%2Fyarillo209120.github.io%2Ftest-cloud-castle%2F
